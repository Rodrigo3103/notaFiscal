...
class Ui_formFornecedor(object):
    def setupUi(self, formFornecedor):
        formFornecedor.setObjectName("formFornecedor")
        formFornecedor.resize(813, 703)
        self.txt_nomefornecedor = QtWidgets.QLabel(formFornecedor)
        self.txt_nomefornecedor.setGeometry(QtCore.QRect(60, 100, 111, 20))
        self.txt_nomefornecedor.setObjectName("txt_nomefornecedor")
        self.bt_sair = QtWidgets.QToolButton(formFornecedor)
        ...
        self.bt_incluir = QtWidgets.QToolButton(formFornecedor)
        ...
        self.bt_pesquisar = QtWidgets.QPushButton(formFornecedor)
        ...
        self.tb_fornecedor = QtWidgets.QTableWidget(formFornecedor)
        self.tb_fornecedor.setEnabled(True)
        self.tb_fornecedor.setGeometry(QtCore.QRect(0, 151, 811, 551))
        self.tb_fornecedor.setFocusPolicy(QtCore.Qt.NoFocus)
        self.tb_fornecedor.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.tb_fornecedor.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAsNeeded)
        self.tb_fornecedor.setAutoScroll(True)
        self.tb_fornecedor.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tb_fornecedor.setTextElideMode(QtCore.Qt.ElideRight)
        self.tb_fornecedor.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.tb_fornecedor.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.tb_fornecedor.setObjectName("tb_fornecedor")
        self.tb_fornecedor.setColumnCount(18)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tb_fornecedor.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        self.tb_fornecedor.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.tb_fornecedor.setHorizontalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        self.tb_fornecedor.setHorizontalHeaderItem(10, item)
        item = QtWidgets.QTableWidgetItem()
        self.tb_fornecedor.setHorizontalHeaderItem(11, item)
        item = QtWidgets.QTableWidgetItem()
        self.tb_fornecedor.setHorizontalHeaderItem(12, item)
        item = QtWidgets.QTableWidgetItem()
        self.tb_fornecedor.setHorizontalHeaderItem(13, item)
        item = QtWidgets.QTableWidgetItem()
        self.tb_fornecedor.setHorizontalHeaderItem(14, item)
        item = QtWidgets.QTableWidgetItem()
        self.tb_fornecedor.setHorizontalHeaderItem(15, item)
        item = QtWidgets.QTableWidgetItem()
        self.tb_fornecedor.setHorizontalHeaderItem(16, item)
        item = QtWidgets.QTableWidgetItem()
        self.tb_fornecedor.setHorizontalHeaderItem(17, item)
        self.tb_fornecedor.horizontalHeader().setVisible(True)
        self.tb_fornecedor.verticalHeader().setVisible(False)
        self.lb_nomefornecedor = QtWidgets.QLineEdit(formFornecedor)
        self.lb_nomefornecedor.setGeometry(QtCore.QRect(160, 100, 461, 20))
        self.lb_nomefornecedor.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.lb_nomefornecedor.setObjectName("lb_nomefornecedor")
        self.bt_pesquisarGeral = QtWidgets.QPushButton(formFornecedor)
        ...
        self.bt_alterar = QtWidgets.QToolButton(formFornecedor)
        ...
        self.bt_consultar = QtWidgets.QToolButton(formFornecedor)
        ...
        self.bt_excluir = QtWidgets.QToolButton(formFornecedor)
        ...
        self.frameDadosfornecedor = QtWidgets.QFrame(formFornecedor)
        self.frameDadosfornecedor.setGeometry(QtCore.QRect(130, 180, 541, 461))
        self.frameDadosfornecedor.setStyleSheet("background-color: rgb(241, 241, 241);")
        self.frameDadosfornecedor.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frameDadosfornecedor.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frameDadosfornecedor.setObjectName("frameDadosfornecedor")
        self.tabWidget = QtWidgets.QTabWidget(self.frameDadosfornecedor)
        self.tabWidget.setEnabled(True)
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 541, 461))
        self.tabWidget.setFocusPolicy(QtCore.Qt.NoFocus)
        self.tabWidget.setObjectName("tabWidget")
        self.tab_fornecedor = QtWidgets.QWidget()
        self.tab_fornecedor.setObjectName("tab_fornecedor")
        self.bt_cancelar = QtWidgets.QToolButton(self.tab_fornecedor)
        ...
        self.bt_avancar = QtWidgets.QToolButton(self.tab_fornecedor)
        ...
        self.frameTab1 = QtWidgets.QFrame(self.tab_fornecedor)
        ...
        self.tabWidget.addTab(self.tab_fornecedor, "")
        ...
        self.bt_inutilizado1 = QtWidgets.QToolButton(formFornecedor)
        ...
        self.bt_inutilizado2 = QtWidgets.QToolButton(formFornecedor)
        ...
        self.bt_inutilizado3 = QtWidgets.QToolButton(formFornecedor)
        ...
        self.bt_inutilizado4 = QtWidgets.QToolButton(formFornecedor)
        ...
        self.retranslateUi(formFornecedor)
        self.tabWidget.setCurrentIndex(0)
        self.bt_cancelar.clicked.connect(self.frameDadosfornecedor.hide) # type: ignore
        self.bt_incluir.clicked.connect(self.frameDadosfornecedor.show) # type: ignore
        self.bt_confirmar.clicked.connect(self.frameDadosfornecedor.hide) # type: ignore
        self.bt_consultar.clicked.connect(self.frameDadosfornecedor.show) # type: ignore
        self.bt_sair.clicked.connect(formFornecedor.close) # type: ignore
        self.bt_alterar.clicked.connect(self.frameDadosfornecedor.show) # type: ignore
        ...
        self.bt_alterarDados.clicked.connect(self.frameDadosfornecedor.hide) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(formFornecedor)
        formFornecedor.setTabOrder(self.lb_razaoSocial, self.lb_class)
        formFornecedor.setTabOrder(self.lb_class, self.lb_nomeFantasia)
        formFornecedor.setTabOrder(self.lb_nomeFantasia, self.lb_cnpjcpf)
        formFornecedor.setTabOrder(self.lb_cnpjcpf, self.lb_ierg)
        formFornecedor.setTabOrder(self.lb_ierg, self.lb_endereco)
        formFornecedor.setTabOrder(self.lb_endereco, self.lb_numero)
        formFornecedor.setTabOrder(self.lb_numero, self.lb_bairro)
        formFornecedor.setTabOrder(self.lb_bairro, self.lb_cidade)
        formFornecedor.setTabOrder(self.lb_cidade, self.lb_cep)
        formFornecedor.setTabOrder(self.lb_cep, self.lb_uf)
        formFornecedor.setTabOrder(self.lb_uf, self.lb_telefone)
        formFornecedor.setTabOrder(self.lb_telefone, self.lb_email)

    def retranslateUi(self, formFornecedor):
        _translate = QtCore.QCoreApplication.translate
        formFornecedor.setWindowTitle(_translate("formFornecedor", "fornecedor"))
        self.txt_nomefornecedor.setText(_translate("formFornecedor", "Nome fornecedor:"))
        self.bt_sair.setText(_translate("formFornecedor", "Sair"))
        self.bt_incluir.setText(_translate("formFornecedor", "Incluir"))
        item = self.tb_fornecedor.horizontalHeaderItem(1)
        item.setText(_translate("formFornecedor", "Razão Social"))
        item = self.tb_fornecedor.horizontalHeaderItem(2)
        item.setText(_translate("formFornecedor", "Nome Fantasia"))
        item = self.tb_fornecedor.horizontalHeaderItem(3)
        item.setText(_translate("formFornecedor", "Classificação"))
        item = self.tb_fornecedor.horizontalHeaderItem(4)
        item.setText(_translate("formFornecedor", "CNPJ/CPF"))
        item = self.tb_fornecedor.horizontalHeaderItem(5)
        item.setText(_translate("formFornecedor", "I.E/RG"))
        item = self.tb_fornecedor.horizontalHeaderItem(6)
        item.setText(_translate("formFornecedor", "Endereço"))
        item = self.tb_fornecedor.horizontalHeaderItem(7)
        item.setText(_translate("formFornecedor", "Número"))
        item = self.tb_fornecedor.horizontalHeaderItem(8)
        item.setText(_translate("formFornecedor", "Bairro"))
        item = self.tb_fornecedor.horizontalHeaderItem(9)
        item.setText(_translate("formFornecedor", "CEP"))
        item = self.tb_fornecedor.horizontalHeaderItem(10)
        item.setText(_translate("formFornecedor", "Cidade"))
        item = self.tb_fornecedor.horizontalHeaderItem(11)
        item.setText(_translate("formFornecedor", "Estado"))
        item = self.tb_fornecedor.horizontalHeaderItem(12)
        item.setText(_translate("formFornecedor", "Telefone"))
        item = self.tb_fornecedor.horizontalHeaderItem(13)
        item.setText(_translate("formFornecedor", "email"))
        item = self.tb_fornecedor.horizontalHeaderItem(14)
        item.setText(_translate("formFornecedor", "Observação"))
        item = self.tb_fornecedor.horizontalHeaderItem(15)
        item.setText(_translate("formFornecedor", "Prazo"))
        item = self.tb_fornecedor.horizontalHeaderItem(16)
        item.setText(_translate("formFornecedor", "Usuário"))
        item = self.tb_fornecedor.horizontalHeaderItem(17)
        item.setText(_translate("formFornecedor", "Auditoria"))
        self.bt_alterar.setText(_translate("formFornecedor", "Alterar"))
        self.bt_consultar.setText(_translate("formFornecedor", "Consultar"))
        self.bt_excluir.setText(_translate("formFornecedor", "Excluir"))
        self.bt_cancelar.setText(_translate("formFornecedor", "Cancelar"))
        self.bt_avancar.setText(_translate("formFornecedor", "Avançar"))
        self.txt_email.setText(_translate("formFornecedor", "E-mail"))
        self.txt_cep.setText(_translate("formFornecedor", "CEP"))
        self.txt_telefones.setText(_translate("formFornecedor", "Telefones:"))
        self.txt_razaoSocial.setText(_translate("formFornecedor", "Razão Social"))
        self.txt_IERG.setText(_translate("formFornecedor", "I.E/RG"))
        self.txt_cidade.setText(_translate("formFornecedor", "Cidade"))
        self.txt_numero.setText(_translate("formFornecedor", "Número"))
        self.txt_endereco.setText(_translate("formFornecedor", "Endereço"))
        self.txt_CNPJCPF.setText(_translate("formFornecedor", "CNPJ/CPF"))
        self.txt_class.setText(_translate("formFornecedor", "Class"))
        self.txt_bairro.setText(_translate("formFornecedor", "Bairro"))
        self.txt_nomeFantasia.setText(_translate("formFornecedor", "Nome Fantasia"))
        self.txt_UF.setText(_translate("formFornecedor", "UF"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_fornecedor), _translate("formFornecedor", "fornecedor"))
        self.bt_confirmar.setText(_translate("formFornecedor", "Confirmar"))
        self.bt_retornar.setText(_translate("formFornecedor", "Retornar"))
        self.txt_CNPJCPF_2.setText(_translate("formFornecedor", "Prazo:"))
        self.txt_observacao.setText(_translate("formFornecedor", "Observação"))
        self.bt_alterarDados.setText(_translate("formFornecedor", "Confirmar"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_dadosAdicionais), _translate("formFornecedor", "Dados adicionais"))

        #Todo: começa aqui a mexer

        self.frameDadosfornecedor.hide()
        self.lb_observacao.setFocus()  # Todo: faz funciona o texto da area grande
        self.bt_sair.clicked.connect(formFornecedor.close)  # Todo: sai da tela.
        ...
        self.bt_confirmar.clicked.connect(self.cadastrarfornecedor)  # Todo: Cadastra fornecedor no banco de dados.
        self.bt_consultar.clicked.connect(self.consultarFornecedor) #Todo: consulta o forncecedor.
        self.bt_alterar.clicked.connect(self.abrirDadosfornecedors) #Todo: carrega os dados dos fornecedors na tela.
        self.bt_alterarDados.clicked.connect(self.alterarDadosfornecedor) #Todo: faz a alteração dos dados fornecedores.
        self.bt_excluir.clicked.connect(self.excluirfornecedor)  # Todo: exclui o fornecedor.
        self.consultarGeral() #Todo carrega a tabela.
        self.tb_fornecedor.selectRow(0)  # Todo: aqui pega-se a primeira linha da tabela.
        ...
        self.bt_incluir.clicked.connect(self.incluirFornecedor)#Todo: abrr a tela incluir fornecedor
    ...
    def consultarGeral(self):
        ...
        try:
            ...
            df_fornecedor = pd.DataFrame(myresult,
                                      columns=['ID FORNECEDOR', 'RAZÃO SOCIAL', 'NOME FANTASIA', 'CLASSIFICAÇÃO', 'CNPJ CPF',
                                               'IE RG', 'ENDEREÇO', 'NÚMERO', 'BAIRRO', 'CEP', 'CIDADE', 'ESTADO',
                                               'TELEFONE', 'E-MAIL', 'OBERSERVAÇÃO', 'PRAZO', 'USUÁRIO DE CADASTRO',
                                               'AUDITORIA'])
            self.all_data = df_fornecedor
            # Todo: Carrega o arquivo na Tabela fornecedor
            numRows = len(self.all_data.index)
            self.tb_fornecedor.setColumnCount(len(self.all_data.columns))
            self.tb_fornecedor.setRowCount(numRows)
            #self.tb_fornecedor.setHorizontalHeaderLabels(self.all_data.columns) #Todo:Setar o título e cabeçalho da tabela

            for i in range(numRows):
                for j in range(len(self.all_data.columns)):
                    self.tb_fornecedor.setItem(i, j, QTableWidgetItem(str(self.all_data.iat[i, j])))

            self.tb_fornecedor.resizeColumnsToContents()
            self.tb_fornecedor.resizeRowsToContents()
    ...
    def consultarNomes(self):
        ...
        procurarNome = self.lb_nomefornecedor.text()
        ...
        try:
            ...
            mycursor = mydb.cursor()
            sql = f"SELECT * FROM fornecedor WHERE razaoSocial LIKE '{procurarNome}%' ORDER BY razaoSocial"
            mycursor.execute(sql)
            myresult = mycursor.fetchall()
            print(myresult)
            df_fornecedor = pd.DataFrame(myresult,
            ...
            self.tb_fornecedor.setColumnCount(len(self.all_data.columns))
            self.tb_fornecedor.setRowCount(numRows)
            # self.tb_fornecedor.setHorizontalHeaderLabels(self.all_data.columns) #Setar o título e cabeçalho da tabela
    ...
    def cadastrarfornecedor(self):
        ...
        try:
            ...
            mycursor = mydb.cursor()
            sql = "INSERT INTO fornecedor (razaoSocial, nomeFantasia, classificacao, cnpjcpf, ierg, endereco, numero, bairro, cidade, cep,  estado, telefone, email, observacao, prazo, usuarioCadastro, auditoria) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
            val = (
    ...
    def consultarFornecedor(self):
        ...
        print('Consultar')
        linha = self.tb_fornecedor.currentRow()
        item = self.tb_fornecedor.item(linha, 0)
        ...
        mycursor = mydb.cursor()
        consultaConsulta = f'SELECT * FROM fornecedor WHERE idFornecedor= "{variaveisDeControles.idConsulta}"'
        ...
        mycursor.close()
        df_fornecedor = pd.DataFrame(myresult,
                                  columns=['idfornecedor', 'razaoSocial', 'nomeFantasia', 'classificacao', 'cnpjcpf',
                                           'ierg', 'endereco', 'numero', 'bairro', 'cep', 'cidade', 'estado',
                                           'telefone', 'email', 'observacao', 'prazo', 'usuarioCadastro',
                                           'auditoria'])

        self.lb_razaoSocial.setText(df_fornecedor.loc[0][1])
        self.lb_nomeFantasia.setText(df_fornecedor.loc[0][2])
        self.lb_class.setText(df_fornecedor.loc[0][3])
        self.lb_cnpjcpf.setText(df_fornecedor.loc[0][4])
        self.lb_ierg.setText(df_fornecedor.loc[0][5])
        self.lb_endereco.setText(df_fornecedor.loc[0][6])
        self.lb_numero.setText((str(df_fornecedor.loc[0][7])))
        self.lb_bairro.setText(df_fornecedor.loc[0][8])
        self.lb_cep.setText(df_fornecedor.loc[0][9])
        self.lb_uf.setText(df_fornecedor.loc[0][10])
        self.lb_cidade.setText(df_fornecedor.loc[0][11])
        self.lb_telefone.setText(df_fornecedor.loc[0][12])
        self.lb_email.setText(df_fornecedor.loc[0][13])
        self.lb_observacao.insertPlainText(df_fornecedor.loc[0][14])
        self.lb_prazo.setText(df_fornecedor.loc[0][15])
        self.frameTab1.setEnabled(False)
        self.frameTab2.setEnabled(False)


    def abrirDadosfornecedors(self):
        ...
        sql = f"SELECT * FROM fornecedor WHERE idFornecedor = '{variaveisDeControles.idConsulta}'"
        mycursor.execute(sql)
        ...
        df_fornecedor = pd.DataFrame(myresult,columns=['idFornecedor', 'razaoSocial', 'nomeFantasia', 'classificacao', 'cnpjcpf',
                                           'ierg', 'endereco', 'numero', 'bairro', 'cep', 'cidade', 'estado',
                                           'telefone', 'email', 'observacao', 'prazo', 'usuarioCadastro',
                                           'auditoria'])
    ...
    def alterarDadosfornecedor(self):


        if self.tb_fornecedor.rowCount() > 1:



            print('Alterando')
            linha = self.tb_fornecedor.currentRow()
            idfornecedorLinha = self.tb_fornecedor.item(linha, 0).text()
            print(f"Linha: {linha}, ID fornecedor: {idfornecedorLinha}")
            # Todo: seta labels das variaveis.
            razaoSocial = self.lb_razaoSocial.text()  # 1
            nomeFantasia = self.lb_nomeFantasia.text()  # 2
            classificacao = self.lb_class.text()  # 3
            ...
            try:
                ...
                sql = f"UPDATE fornecedor SET razaoSocial = '{razaoSocial}', nomeFantasia = '{nomeFantasia}', classificacao = '{classificacao}', cnpjcpf = '{cnpjcpf}', ierg = '{ierg}', endereco = '{endereco}', numero = '{numero}', bairro = '{bairro}', cep = '{cep}', cidade = '{cidade}', estado = '{estado}', telefone = '{telefone}', email = '{email}', observacao = '{observacao}', prazo = '{prazo}' WHERE idfornecedor = '{idfornecedorLinha}'"
                ...
                msg.setText(f'ID: {idfornecedorLinha} alterado com sucesso')
                msg.exec()
                self.consultarGeral()
                #self.limpaTela()
                ...
                print(f'\033[0;34m{idfornecedorLinha}\033[m')
                print('Id de alteração: ', idfornecedorLinha)
            except:
                print('')
                msg = QMessageBox()
                msg.setIcon(QMessageBox.Critical)
        ...
        if self.tb_fornecedor.rowCount()>1:
            ...
            if ret == QMessageBox.StandardButton.Yes:
                ...
                try:
                    ...
                    mycursor = mydb.cursor()
                    sql = f"DELETE From fornecedor WHERE idfornecedor = '{idfornecedorLinha}'"
                    mycursor.execute(sql)
                    mydb.commit()
                    ...
                    msg.setIcon(QMessageBox.Information)
                    msg.setWindowTitle("Aviso")
                    msg.setText(f"fornecedor {idfornecedorLinha} Excluido com sucesso")
                    msg.exec_()
                    self.consultarGeral()
                ...
                #msg = QMessageBox()
                #msg.setWindowTitle("Aviso")
                #msg.setText("fornecedor não excluido")
                #msg.setStandardButtons(QMessageBox.StandardButton.Ok)
                #ret = msg.exec()
...
if __name__ == "__main__":
    ...
    formFornecedor = QtWidgets.QWidget()
    ui = Ui_formFornecedor()
    ui.setupUi(formFornecedor)
    formFornecedor.show()
    sys.exit(app.exec_())
